...
class S {
  ...
  String get captain_information {
    return Intl.message(
      'Captain\'s Information',
      name: 'captain_information',
      desc: '',
      args: [],
    );
  }
  ...
  String get password_set_successfully {
    return Intl.message(
      'Password Set Successfully',
      name: 'password_set_successfully',
      desc: '',
      args: [],
    );
  }
  ...
  /// `You'r about to log out`
  String get warning_logout_message {
    return Intl.message(
      'You\'r about to log out',
      name: 'warning_logout_message',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Work Area`
  String get work_area {
    return Intl.message('Work Area', name: 'work_area', desc: '', args: []);
  }
